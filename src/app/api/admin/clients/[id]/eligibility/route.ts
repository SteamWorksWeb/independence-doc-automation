/**
 * src/app/api/admin/clients/[id]/eligibility/route.ts
 *
 * GET /api/admin/clients/[id]/eligibility
 *
...
export async function GET(
  ...
  if (!backendBase) {
    console.error("[proxy/admin/clients/:id/eligibility] NEXT_PUBLIC_AWS_API_URL is not set.");
    return NextResponse.json(
  ...
  const targetUrl = `${backendBase}/admin/clients/${id}/eligibility`;
  ...
  try {
    ...
    console.error("[proxy/admin/clients/:id/eligibility] Network error reaching backend:", err);
    return NextResponse.json(
  ...
  try {
    ...
    console.error("[proxy/admin/clients/:id/eligibility] Backend returned non-JSON response.");
    return NextResponse.json(
