...
export async function PATCH(
  ...
  const targetUrl = buildBackendUrl(`/admin/leads/${id}/status`);
  if (!targetUrl) {
    console.error("[proxy/admin/leads/:id/status] NEXT_PUBLIC_AWS_API_URL is not set.");
    return NextResponse.json(
  ...
  try {
    ...
    console.error("[proxy/admin/leads/:id/status] Network error:", err);
    return NextResponse.json(
