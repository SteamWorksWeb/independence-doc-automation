...
export const metadata: Metadata = {
  title: "Verify Email — Liberty Client Portal",
  description: "Email address verification for Liberty Client Portal.",
  ...
  if (response.status === 200) {
    return {
      ...
      message:
        ...
        "Email address verified successfully. You may now log in to the Liberty Client Portal.",
    };
  }
