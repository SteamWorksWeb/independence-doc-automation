  ...
  return (
    <div className="flex items-center gap-2" ref={dropdownRef}>
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div
            className="absolute right-0 top-[calc(100%+4px)] z-[200] min-w-[210px] bg-white rounded-lg border border-border shadow-lg py-1 animate-fade-in"
            role="menu"
          ...
          >
            ...
            {/* ── Divider before destructive / admin actions ── */}
