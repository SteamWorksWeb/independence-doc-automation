 ...
 *
 * UX contract:
 *   - Email + Password fields, with accessible labels and live validation
 *   - Calls the `loginClient` Server Action via useTransition
 *   - UNVERIFIED (403): amber banner — "check your inbox" (no resend endpoint yet)
 ...
 *   - ok: true → router.push('/dashboard') — cookie already set server-side
 *
 * Security notes:
 *   - No credentials are logged or stored client-side
 *   - The JWT cookie is written server-side by the loginClient action,
 *     invisible to this component (httpOnly)
 *   - All API communication happens inside the Server Action
 */
